...
<?php echo e(trans('Countries::countries.countries')); ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="admin-top-operation">
            <a class="btn btn-default" href="<?php echo e(action('\UiStacks\Countries\Controllers\CountriesController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Countries::countries.country')); ?></a>
        </div>

        <?php if($items->count() || $_GET): ?>
            <?php echo $__env->make('Countries::countries.filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>

        <?php if($items->count()): ?>
            <form method="POST" action="<?php echo e(action('\UiStacks\Countries\Controllers\CountriesController@bulkOperations')); ?>" id="bulk" class="form-inline">
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr <?php if($item->trans): ?> data-title="<?php echo e($item->trans->name); ?>" <?php endif; ?>>
                                    ...
                                    <td class="user_name_col_<?php echo e($item->id); ?>">
                                        <?php if(isset($item->trans->flag)): ?>
                                        <?php 
                                            $exist_flag = url('/').'/uploads/countries-flag/'.$item->trans->flag;
                                                if (file_exists($exist_flag)) {
                                                    $exist_flag = $exist_flag;
                                                } else {
                                                    $exist_flag = url('/').'/admin_assets/img/countries_flags/'.$item->trans->flag;
                                                }
                                         ?>
                                        <img src="<?php echo e(isset($item->trans->flag) ? $exist_flag : ""); ?>" />
                                        <?php endif; ?>
                                        <?php if($item->trans): ?>
                                            <?php echo e(ucwords(strtolower($item->trans->name))); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                    <td>
                                       <a href="<?php echo e(action('\UiStacks\Countries\Controllers\CountriesController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
        ...
        <?php else: ?>
            <div class="text-center">
                <?php if($_GET): ?>
                    <h1><?php echo e(trans('admin.no_results_found')); ?> <a href="<?php echo e(action('\UiStacks\Countries\Controllers\CountriesController@index')); ?>"><?php echo e(trans('admin.back')); ?></a></h1>
                <?php elseif(Request::is(''.Lang::getlocale().'/admin/countries')): ?>
                    <h1><?php echo e(trans('admin.no_data_added_before')); ?> <a href="<?php echo e(action('\UiStacks\Countries\Controllers\CountriesController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Countries::countries.country')); ?></a></h1>
                <?php endif; ?>
             </div>
        <?php endif; ?>
    </div>
