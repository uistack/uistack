...
<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('Tutorials::tutorials.courses')); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="admin-top-operation">
                <a class="btn btn-default" href="<?php echo e(action('\UiStacks\Tutorials\Controllers\CoursesController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Tutorials::tutorials.course')); ?></a>
            </div>
            ...
            <?php endif; ?>
            <?php if($items->count()): ?>
                <form method="POST" action="<?php echo e(url('/')."/ar/admin/tutorials/bulk-operations"); ?>" id="bulk" class="form-inline">
                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <?php if(isset($item->trans)): ?>
                                        <tr <?php if($item->trans): ?> data-title="<?php echo e($item->trans->name); ?>" <?php endif; ?>>
                                            ...
                                            <td>
                                                <a href="<?php echo e(action('\UiStacks\Tutorials\Controllers\CoursesController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
                                                &nbsp;<a href="<?php echo e(action('\UiStacks\Tutorials\Controllers\SectionsController@index', $item->id)); ?>"><i class="fa fa-table"></i> Sections</a>&nbsp;
                    ...
                    <div class="form-group">
                        ...
                        <select name="operation" id="operation" class="form-control" required="required">
                            ...
                            <option value="read"><?php echo e(trans('Tutorials::tutorials.read')); ?></option>
                            <option value="unread"><?php echo e(trans('Tutorials::tutorials.unread')); ?></option>
