...
<head>
    ...
    <?php if(isset($webmeta)): ?>
        ...
        <meta name="keywords" content="<?php echo e($webmeta['keywords']); ?>">
    <?php else: ?>
        ...
        <meta name="description" content="UiStacks a web design and development solution , at UiStacks our mission to help businesses throughout the world realize their potential , UiStacks , UiStacksindia , UiStacks india">
        <meta name="keywords" content="web development companies, node js web development in India, nodejs development company, nodejs development company in india, nodejs development company in patna, ROR website development company, web design & development company , UiStacks , UiStacksindia , UiStacks india"> 
    <?php endif; ?>
