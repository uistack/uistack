    ...
    <div class="row">
        <div class="col-md-12">
            <div class="admin-top-operation">
                <a class="btn btn-default" href="<?php echo e(action('\UiStacks\Blogs\Controllers\BlogsController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Blogs::blogs.blog')); ?></a>
            </div>
            <?php if($items->count() || $_GET): ?>
                <?php echo $__env->make('Blogs::blogs.filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php endif; ?>
            <?php if($items->count()): ?>
                <form method="POST" action="<?php echo e(url('/')."/ar/admin/blogs/bulk-operations"); ?>" id="bulk" class="form-inline">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(trans('Blogs::blogs.name')); ?></th>
                                <th><?php echo e(trans('Blogs::blogs.description')); ?></th>
                                <th><?php echo e(trans('Blogs::blogs.date')); ?></th>
                                <th><?php echo e(trans('Blogs::blogs.view')); ?></th>
                                <th> <?php echo e(trans('Blogs::blogs.status')); ?> </th>
                                <th><?php echo e(trans('Blogs::blogs.delete')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                                            ...
                                            <td>
                                                <?php if($item->trans): ?>
                                                    <?php if($item->trans->is_reply==1): ?>
                                                        <?php echo e(trans('Blogs::blogs.replied_status')); ?>

                                                    <?php else: ?>
                                                        <?php echo e(trans('Blogs::blogs.not_replied_status')); ?>

                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(url('/')); ?>/<?php echo e(Lang::getLocale()); ?>/admin/blogs/<?php echo e($item->id); ?>"><i class="fa fa-eye"></i> <?php echo e(trans('Blogs::blogs.viewReply')); ?></a>
                                            </td>
                                            <td>
                                                <?php if($item->trans->is_read == true): ?>
                                                    <a href='<?php echo e(url('/')."/".Lang::getLocale()."/"."admin/blogs/change-status/".$item->id); ?>' class='label label-success'><?php echo e(trans('Blogs::blogs.read')); ?> </a>
                                                <?php else: ?>
                                                    <a href='<?php echo e(url('/')."/".Lang::getLocale()."/"."admin/blogs/change-status/".$item->id); ?>' class='label label-danger'> <?php echo e(trans('Blogs::blogs.unread')); ?></a>
                                                <?php endif; ?>
                            ...
                            <?php else: ?>
                                <?php echo e(trans('Blogs::blogs.no_message_found')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="operation" id="operation" class="form-control" required="required">
                            ...
                            <option value="read"><?php echo e(trans('Blogs::blogs.read')); ?></option>
                            <option value="unread"><?php echo e(trans('Blogs::blogs.unread')); ?></option>
