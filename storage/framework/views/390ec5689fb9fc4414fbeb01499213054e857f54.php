...
<head>
    <title><?php echo e(\UiStacks\Settings\Models\Setting::find(1)->value); ?> - Web Design & Developer Console</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url("/")); ?>/public/website_assets/img/favicon.ico" />
    <link rel="apple-touch-icon-precomposed" href="<?php echo e(url("/")); ?>/public/website_assets/img/ui-stacks.png">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/website_assets/css/burger-menu.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/website_assets/css/bootstrap.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/website_assets/css/new.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/website_assets/css/header.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/website_assets/css/footer.css')); ?>" />
    <meta name="msvalidate.01" content="2541484BA40CEA7D4C741B000D54FFA3" />
    <script src="<?php echo e(asset('public/website_assets/js/vwo.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/website_assets/js/mustache.js')); ?>"></script>
<script src="<?php echo e(asset('public/website_assets/js/tp_snippets.js')); ?>"></script>
<script>
    TpJsSnippet.init("website");
</script>
<script src="<?php echo e(asset('public/website_assets/js/application.js')); ?>"></script>
...
<!--typekit async-->
<script type="text/javascript" src="<?php echo e(asset('public/website_assets/js/typekit-dyq8zgf.js')); ?>"></script>
