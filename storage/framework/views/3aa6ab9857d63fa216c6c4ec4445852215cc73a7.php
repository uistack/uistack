                ...
                <div class="item active">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-pull-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/demo/macbook2016.png" class="img-responsive" alt="..."> </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/demo/watch.png" class="img-responsive" alt="..."> </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-pull-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/demo/book.png" class="img-responsive" alt="..."> </div>
                    </div>
                </div>
            </div>
        </div>
