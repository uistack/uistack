        ...
        <form action="" method="GET" class="form-inline">
        	...
        	<?php 
		  	...
		  	<?php echo $__env->make('Core::fields.input_text', [
                'field_name' => 'name',
                'name' => trans('Activities::activities.activity'),
                'value' => $nameValue,
                'placeholder' => ''
            ...
            <?php echo $__env->make('Core::fields.select', [
		  	...
		  	<a href="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@index')); ?>" class="btn btn-default"><?php echo e(trans('Core::operations.reset')); ?></a>
		</form>
