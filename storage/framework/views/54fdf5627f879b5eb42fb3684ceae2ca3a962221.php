                                ...
                                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <?php if(isset($item->trans)): ?>
                                        <tr <?php if($item->trans): ?> data-title="<?php echo e($item->trans->name); ?>" <?php endif; ?>>
                                            ...
                                            <td>
                                                <a href="<?php echo e(action('\UiStacks\Blogs\Controllers\BlogsController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
                                                &nbsp;<a href="<?php echo e(action('\UiStacks\Blogs\Controllers\CommentsController@index', $item->id)); ?>"><i class="fa fa-comment"></i> Comments</a>&nbsp;
