            ...
            <div class="modal-body">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="ms-login-tab">
                        ...
                        <form name="frm_login" id="frm_login" action="<?php echo e(action('WebsiteController@postLogin')); ?>" method="post" autocomplete="off">
                            <fieldset>
                        ...
                        <div class="text-center">
                            <h3>Login with</h3>
                            <a href="<?php echo e(url('/auth/facebook')); ?>" class="wave-effect-light btn btn-raised btn-facebook">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="ms-register-tab">
                        <?php echo $__env->make('website.blocks.page-message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <form name="frm_registration" id="frm_registration" action="<?php echo e(action('WebsiteController@postRegister')); ?>" method="post" >
                            <fieldset>
                                <div class="form-group label-floating">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="ms-recovery-tab">
                        <?php echo $__env->make('website.blocks.page-message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <form name="frm_forgot_password" id="frm_forgot_password" action="<?php echo e(action('WebsiteController@forgotPasswordUserValidation')); ?>" method="post" autocomplete="off">
                        <fieldset>
                            <div class="form-group label-floating">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
