					...
					<?php if(isset($item)): ?>
						...
						<div class="post-media post-comments">
							...
							<?php if(isset($comments)): ?>
								<?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c => $comment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									<div class="media">
										<a class="pull-left" href="#">
											<img class="media-object" alt="" src="<?php echo e(asset('public/website_assets/img/node.png')); ?>">
										</a>
										<div class="media-body">
											<h5 class="media-heading"><?php echo e($comment->commentedBy->name); ?></h5>
											<span class="pull-right"> <span> <a href="#" onclick="showReplyModal('<?php echo e($comment->id); ?>','<?php echo e($item->id); ?>');"><i class="fa fa-reply"></i> Reply</a></span> </span>
											<p>
												<?php echo e($comment->trans->body); ?>

											</p>
											<span class="date pull-right"><?php echo e($comment->trans->created_at); ?></span>
											<hr>
											<!-- Nested media object -->
											<div class="media">
												<a class="pull-left" href="#">
						...
						<div class="post-block post-leave-comment">
							...
							<form id="frm_comment" method="post" action="<?php echo e(action('BlogController@comment',$item->slug)); ?>">
								<?php if(Auth::guest()): ?>
									<div class="row">
								...
								<input id="post_id" name="post_id" class="form-control" value="<?php echo e($item->id); ?>" type="hidden">
								<div class="row">
									<div class="col-md-12">
...
<?php $__env->startSection('footer'); ?>
	<div class="modal modal-royal" id="replyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog animated zoomIn animated-3x" role="document">
			<div class="modal-content">
				<form class="form-horizontal" id="frm_comment_popup" method="post" action="<?php echo e(action('BlogController@comment',$item->slug)); ?>">
	...
	<script defer src="<?php echo e(asset('public/website_assets/js/customize/blog.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
