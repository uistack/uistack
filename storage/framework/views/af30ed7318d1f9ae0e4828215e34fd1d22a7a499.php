                                ...
                                <div class="media">
                                    <div class="media-left media-middle">
                                        <a href="javascript:void(0)">
                                            <img class="media-object media-object-circle" src="<?php echo e(url('/')); ?>/public/website_assets/img/demo/p75.jpg"  alt="Articles" title="Articles">
                                        </a>
                                    </div>
...
<footer class="ms-footer">
    ...
    <div class="ftr__made-in-india">
        Made in <img class="ftr__flag" src="<?php echo e(url('/')); ?>/public/website_assets/img/in.png" alt="IN" title="IN"/> with <span class="ftr-heart">❤</span>
    </div>
</footer>
