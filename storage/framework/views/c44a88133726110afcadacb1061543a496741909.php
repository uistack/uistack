<?php 
    $breadcrumbs = [
                        ['url' => '', 'name' => trans('Activities::activities.activities')]
    ];
    $dbTable = '';
    if($items->count()){
...
<?php $__env->startSection('page_title'); ?>
    <?php echo e(trans('Activities::activities.activities')); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="admin-top-operation">
                <a class="btn btn-default" href="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Activities::activities.activity')); ?></a>
            </div>
            <?php if($items->count() || $_GET): ?>
                <?php echo $__env->make('Activities::activities.filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php endif; ?>
            <?php if($items->count()): ?>
                <form method="POST" action="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@bulkOperations')); ?>" id="bulk" class="form-inline">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(trans('Activities::activities.name')); ?></th>
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr <?php if($item->trans): ?> data-title="<?php echo e($item->trans->name); ?>" <?php endif; ?>>
                                    ...
                                    <?php endif; ?>
                                    <td>
                                        <a href="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
            ...
            <?php else: ?>
                <div class="text-center">
                    <?php if($_GET): ?>
                        <h1><?php echo e(trans('admin.no_results_found')); ?> <a href="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@index')); ?>"><?php echo e(trans('admin.back')); ?></a></h1>
                    <?php elseif(Request::is(''.Lang::getlocale().'/admin/activities')): ?>
                        <h1><?php echo e(trans('admin.no_data_added_before')); ?> <a href="<?php echo e(action('\UiStacks\Activities\Controllers\ActivitiesController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Activities::activities.activity')); ?></a></h1>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
