            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="carousel-caption">
                                ...
                                <a href="<?php echo e(action("WebsiteController@createContact")); ?>" class="btn btn-success btn-raised">Need Help <i class="fa fa-question-circle"></i></a>
                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/banner/1.png" class="img-responsive" alt="Banner1"> </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-pull-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/banner/2.png" class="img-responsive" alt="Banner2"> </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-pull-6">
                            <img src="<?php echo e(url('/')); ?>/public/website_assets/img/banner/3.png" class="img-responsive" alt="Banner3"> </div>
                    </div>
                </div>
            </div>
        </div>
