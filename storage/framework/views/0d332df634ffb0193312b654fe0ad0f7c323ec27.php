    ...
    <div class="container container-full">
        <div class="ms-title">
            <a href="<?php echo e(url('/').'/'.Lang::getlocale().'/home'); ?>">
                <img class="logo" src="<?php echo e(url('/')); ?>/public/website_assets/img/logo.png"  alt="UiStacks System" title="UiStacks System">
    ...
    <div class="container container-full">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="<?php if(\Request::segment(3) == "blog"): ?> active <?php endif; ?>">
                    <a href="<?php echo e(action('BlogController@index')); ?>" class="dropdown-toggle animated fadeIn animation-delay-7" data-name="blog">Blog</a>
                </li>
                ...
                <?php else: ?>
                    <li class="<?php if(\Request::segment(3) == "marketplace"): ?> active <?php endif; ?>">
                        <a href="<?php echo e(url('/').'/'.Lang::getlocale().'/marketplace'); ?>" class="dropdown-toggle animated fadeIn animation-delay-9" data-name="ecommerce">Deals</a>
                    </li>
                <?php endif; ?>
