...
var url_to_file_manager = 'http://localhost:8000/en/browse/images';
...
$(document).ready(function(){
    ...
    $(document).on('click', '#image-manager-insert', function () {
        var fileID = $(this).closest(".selected").attr("id");
        element.val(fileID);
    ...
    function GetTheHtml(existing_files){
        var html = '';
        html += '<input type="hidden" name="image-manager-src" id="image-manager-src" value=""/>';
        ...
        html += '<iframe src="' + url_to_file_manager +'" frameborder="0" width="885" height="400"></iframe>';
