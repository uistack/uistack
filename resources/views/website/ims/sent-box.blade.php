                        ...
                        @foreach($all_msgs as $item)
                            <tr data-title="{{ $item->subject }}">
                                ...
                                <td>
                                    ...
                                    {{--@endif--}}
                                    <a href="{{ url('/')."/".Lang::getlocale()."/"."delete-sent-msg/". $item->id }}" onclick="return confirm('هل تريد حقا حذف هذا العنصر؟');" ><i class="fa fa-trash"></i> {{ trans('Core::operations.delete') }}</a>
