    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="javascript:void(0)" class="btn btn-raised btn-white color-info animated fadeInRight animation-delay-14">Buy Now</a>
            </div>
            <div class="col-md-6 text-center">
                <img src="{{ url('/') }}/public/website_assets/img/demo/pixelPro.png" alt="" class="img-responsive animated bounceInRight animation-delay-14">
            </div>
        </div>
    </div>
</div>