        ...
        <div class="cn-login__header">
            <div class="cn-login__nav">
                ...
                <div class="cn-login__signup">
                    ...
                    <a href="/signup" class="cn-login__signup-btn" tabindex="-1">
                        Sign up &rarr;
                    </a>
                </div>
            </div>
        ...
        <div class="cn-login__block">
            <div class="cn-login__left">
                ...
                <div class="cn-login__media">
                    ...
                    <div class="cn-login__media-heading">
                        <a href="https://www.chargebee.com/new-email-notifications/?utm_source=login_banner" target="_blank">
                    ...
                    <div class="cn-login__media-body">
                        ...
                        <a href="https://www.chargebee.com/new-email-notifications/?utm_source=login_banner" target="_blank">
                            <div class="cn-login__media-thumb" style="background-image:url('https://d190vb4jo83j4z.cloudfront.net/email_send.png'); background-size:120px 120px"></div>
                        </a>

                        <div class="cn-login__media-text">
                            <div>
                                Send transactional emails that delight and inform. Easy customer targeting and so much more.
                            </div>
                            <div>
                                {{--<a href="https://www.chargebee.com/new-email-notifications/?utm_source=login_banner" class="cn-login__media-link" target="_blank">--}}
                                    {{--Learn more--}}
                                {{--</a>--}}
                            </div>
                        </div>
            ...
            <div class="cn-login__right cn-modules">
                <div id="cb-user-login" class="clearfix">
                    <div  class="cb-form-container cn-login__form cn-form" ><form  id="users_login_submit"  name="users_login_submit"  method="post"  action="/users/login_submit"  ajax="true"  ajaxEvent="handleForward"  autocomplete="on"  data-loading-text="Loading..."  validate="true" >
                            <div class="cn-login__form-title">Sign into Chargebee</div>
                            <div class="cn-form__field">
                                <input type="text" autofocus="true" name="email" id="email" value="" class="cn-form__control"
                                       placeholder="name@company.com" validate="true">
                            ...
                            <div id="cb-alert-registration-fields">
                                <div class="cn-form__field">
                                    <div class="cn-form__password cn-form__group">
                                        <input id="password" type="password" autocomplete="off" name="password" value="" class="cn-form__control"
                                               placeholder="password" validate="true">
                    ...
                    <script>
                        var users_login_submit = {"validators":{"email":{"presence":{"message":"cannot be blank"},"email":{"message":" should be a valid email"},"is_account_registered":{"message":"account not yet registered"}},"password":{"presence":{"message":"cannot be blank"},"length":{"message":" should be between 8 and 56 characters","minimum":8,"maximum":56}},"login_token":{"presence":{"message":"cannot be blank"},"length":{"message":" should not have more than 70 characters","maximum":70}},"forward":{"allow_blank":true}},"strategy":"onsubmit","stripEmptyParams":false};</script>
                    <div class="cn-login__mail clearfix" id="cb-alert-registration" style="display:none">
                        ...
                        <div class="cn-login__mail-content">
                            ...
                            <div>
                                <div  class="cb-form-container"  style="display:inline-block;" ><form  id="users_resend_registration_unauth"  name="users_resend_registration_unauth"  method="post"  action="/users/resend_registration_unauth"  ajax="true"  ajaxEvent="formhandler"  autocomplete="on"  data-loading-text="Loading..."  validate="true" >
                                        <input type ='hidden'  name="email"  value="" />
                                        <a id="cb-alert-resend-mail" tabindex="-1">Resend Email</a>
                                    </form> </div><script>var users_resend_registration_unauth = {"validators":{"email":{"presence":{"message":"cannot be blank"},"email":{"message":" should be a valid email"}}},"strategy":"onsubmit","stripEmptyParams":false};</script>
                            </div>
                        </div>
                    </div>
                ...
                <div id="cb-forgot-password" style="display:none;">
                    <div  class="cb-form-container cn-form" ><form  id="forgot_passwords_email_submit"  name="forgot_passwords_email_submit"  method="post"  action="/forgot_passwords/email_submit"  ajax="true"  ajaxEvent="forgotPwdHandler"  autocomplete="on"  data-loading-text="Loading..."  validate="true" >
                            <div class="cn-form__field">
                        ...
                        </form> </div><script>var forgot_passwords_email_submit = {"validators":{"email":{"presence":{"message":"cannot be blank"},"email":{"message":" should be a valid email"}}},"strategy":"onsubmit","stripEmptyParams":false};</script>
                </div>
