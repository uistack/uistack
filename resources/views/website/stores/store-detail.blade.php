                                        ...
                                        <div class="demo-gallery">
                                            <ul id="lightgallery" class="list-unstyled row">
                                                @if (isset($gallery_images) && count($gallery_images) > 0)
                                                    ...
                                                    @endforeach
                                                @endif
                                                {{--<li class="col-xs-6 col-sm-4 col-md-3 img-gallery" data-responsive="img/4-375.jpg 375, img/4-480.jpg 480, img/4.jpg 800" data-src="img/image-3.jpg" data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">--}}
                                                {{--<a href=""> <img class="img-responsive" src="img/image-3.jpg"> </a>--}}
                                                {{--</li>--}}
                                                {{--<li class="col-xs-6 col-sm-4 col-md-3 img-gallery" data-responsive="img/4-375.jpg 375, img/4-480.jpg 480, img/4.jpg 800" data-src="img/image-3.jpg" data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">--}}
                                                {{--<a href=""> <img class="img-responsive" src="img/image-3.jpg"> </a>--}}
                                                {{--</li>--}}
