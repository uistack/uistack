...
class FaqsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        $this->loadViewsFrom(__DIR__.'/views', 'Faqs');

        // Publish views if we need to customize views instead of default one. 
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/faqs'),
        ], 'views');
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/Lang/' => resource_path('lang/vendor/faqs'),
        ], 'lang');
