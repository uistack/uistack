...
class Country extends Model
{
    ...
    {
//        return $this->hasOne('\UiStacks\Countries\Models\CountryTrans', 'country_id')->where('lang', Lang::getlocale())->select(['country_id', 'name']);
        return $this->hasOne('\UiStacks\Countries\Models\CountryTrans', 'country_id')->where('lang', Lang::getlocale())->select('*')->orderBy('name','ASC');
    }
