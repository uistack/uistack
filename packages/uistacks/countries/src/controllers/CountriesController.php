...
use UiStacks\Countries\Controllers\CountriesApiController as API;
...
class CountriesController extends CountriesApiController
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        return view('Countries::countries.index', compact('items'));
    }
    ...
    {
        return view('Countries::countries.create-edit');
    }
...
//            'phone_code' => 'required|unique:countries_trans',
        ...
        return redirect(action('\UiStacks\Countries\Controllers\CountriesController@index'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Countries::countries.create-edit', compact('item', 'trans'));
    }
    ...
    {
        $item = Country::findOrFail($id);
        return view('Countries::countries.confirm-delete', compact('item'));
    }
