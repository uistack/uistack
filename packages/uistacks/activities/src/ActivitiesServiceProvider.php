    ...
    public function boot()
    {
        ...
        */
        ...
        $this->mergeConfigFrom(
            __DIR__.'/config/activities.php', 'activities'
        );
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/activities'),
        ], 'views');
        ...
        */
        $this->publishes([
            __DIR__.'/Public' => public_path('vendor/activities'),
        ], 'public');
