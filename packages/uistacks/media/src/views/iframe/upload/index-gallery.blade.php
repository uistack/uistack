...
{{-- <link href="{{ asset('public/media/image-picker/image-picker.css') }}" rel="stylesheet" type="text/css" /> --}}
<script src="{{ asset('public/admin_assets/js/jquery-1.11.1.min.js') }}"></script>
{{-- <script src="{{ asset('public/media/image-picker/image-picker.js') }}"></script> --}}
@endsection
@section('content')
