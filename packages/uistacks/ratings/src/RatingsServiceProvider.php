    ...
    public function boot()
    {
        ...
        */
        ...
        $this->mergeConfigFrom(
            __DIR__.'/config/ratings.php', 'ratings'
        );
        ...
        */
        ...
        $this->loadViewsFrom(__DIR__.'/views', 'Ratings');

        // Publish views if we need to customize views instead of default one. 
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/ratings'),
        ], 'views');
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/Lang/' => resource_path('lang/vendor/ratings'),
        ], 'lang');
        ...
        */
        $this->publishes([
            __DIR__.'/Public' => public_path('vendor/ratings'),
        ], 'public');
