...
class AdsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/ads'),
        ], 'views');
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/Lang/' => resource_path('lang/vendor/ads'),
        ], 'lang');
        ...
        */
        $this->publishes([
            __DIR__.'/Public' => public_path('vendor/ads'),
        ], 'public');
