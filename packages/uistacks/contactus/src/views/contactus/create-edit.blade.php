@php
    ...
    $breadcrumbs[] =  ['url' => url('/').'/'.Lang::getLocale().'/admin/contactus', 'name' => trans('Pages::pages.pages')];
    ...
    if(Request::is('*/edit')){
        ...
        $breadcrumbs[] =  ['url' => url('/').'/'.Lang::getLocale().'/admin/contactus', 'name' => trans('Core::operations.edit').' '.trans('Pages::pages.page')];
