    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="admin-top-operation">
                <a class="btn btn-default" href="{{ action('\UiStacks\Users\Controllers\UsersController@create', $role)}}">{{ trans('Core::operations.create') }} {{ $itemTitle }}</a>
            </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            @foreach($items as $item)
                                <tr @if($item->trans) data-title="{{ $item->trans->name }}" @endif>
                                    ...
                                    {{--@endif--}}
                                    <td>
                                        <a href="{{ action('\UiStacks\Users\Controllers\UsersController@edit', [$role, $item->id]) }}"><i class="fa fa-edit"></i> {{ trans('Core::operations.edit') }}</a>
