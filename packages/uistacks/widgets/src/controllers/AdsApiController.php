...
//        $rules['name'] = 'unique:ads_trans';
    ...
    public function listItems(Request $request) {
        $ads = Ad::FilterName()->FilterStatus()->orderBy('id', 'DESC')->paginate($request->get('paginate'));
    ...
    public function storeAd(Request $request) {
        ...
        $response = ['message' => trans('Ads::ads.saved_successfully')];
    ...
    public function updateAd(Request $request, $apiKey = '', $id) {
        ...
        $response = ['message' => trans('Ads::ads.updated_successfully')];
        return response()->json($response, 201);
    }
