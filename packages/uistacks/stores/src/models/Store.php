...
//    ];
    ...
    {
//        return $this->hasOne('\UiStacks\Stores\Models\StoreTrans', 'store_id')->where('lang', Lang::getlocale())->select(['store_id', 'name']);
        return $this->hasOne('\UiStacks\Stores\Models\StoreTrans', 'store_id')->where('lang', Lang::getlocale());
    }

    public function images()
    {
//        return $this->hasMany('\UiStacks\Stores\Models\StoreImage', 'store_id')->select(['store_id', 'options']);
        return $this->hasMany('\UiStacks\Stores\Models\StoreImage', 'store_id')->select(['store_id', 'options']);
    }
    //ratings
...
//        return $this->belongsTo('UiStacks\Activities\Models\ActivityTrans', 'activity_id')->where('lang', Lang::getlocale())->select(['id', 'name']);
 ...
 //    public function getlastUpdateByAttribute()
     ...
     */
    //store name
    public function scopeStoreName($query)
    {
        $getName = '';
